    ...
    <div className='container'>
        <form onSubmit={handleSubmit}>
            <div className="mb-3">
                ...
                <input type="name" className="form-control" id="name" name="name" maxLength={10} minLength={3} onChange={onchange} required/>
            </div>
            <div className="mb-3">
            ...
            <button disabled={auth.password.length<5 || auth.cpassword.length<5 || auth.name.length<3} type="submit" className="btn btn-primary" >Signup</button>
        </form>
    </div>
  )
}
